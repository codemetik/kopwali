...
<div class="row">
	<div class="card col-lg-2 p-2">
		<ul class="list-group">
		  <li class="list-group-item bg-light d-flex justify-content-between align-items-center"><a href="?sim=simpan" class="nav-link text-dark">Simpanan</a> <span class="badge bg-primary rounded-pill"><?= simpanan($koneksi)."(".date('Y').")"; ?></span></li>
