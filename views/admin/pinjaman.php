...
<div class="row">
	<div class="card col-lg-2 p-2">
		<ul class="list-group">
		  ...
		  <li class="list-group-item bg-light d-flex justify-content-between align-items-center"><a href="?pin=load_approv" class="nav-link text-dark">Load Approved</a> <span class="badge bg-primary rounded-pill">10</span></li>
		</ul>
		<hr>
		<ul class="list-group">
